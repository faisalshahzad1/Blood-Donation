...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{URL ::to('public/plugins/font-awesome/css/font-awesome.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{URL ::to('public/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
  <!-- Theme style -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Faisal Shahzad</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{URL ::to('/backend')}}" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{URL ::to('/allblog')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>All Blogs</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL ::to('/addblog')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add Blogs</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{URL ::to('/allvolunteer')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>All Volunteers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL ::to('/addvolunteer')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add Volunteer</p>
                </a>
              </li>
